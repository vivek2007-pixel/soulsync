...
*A mindful AI chat experience built with Groq + Node.js + MongoDB + Vanilla JavaScript.*
...
It combines a calming UI, minimal design, and an empathetic AI chatbot powered by Groq to help users reflect, unload stress, and talk openly — anytime.

✔ **Logged-in users:** Unlimited chats saved
✔ **Guest mode:** 5-message preview using Groq API
...
* Custom prompt tuning with Llama 3.3 70B
